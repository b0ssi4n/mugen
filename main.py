...
from mugen import CarParkTool

__CHANNEL_USERNAME__ = "無限 MUGEN"
__GROUP_USERNAME__   = "無限 MUGEN"
...
def banner(console):
    ...
    brand_name = figlet_format('無限 MUGEN', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐅𝐁 @ 無限 MUGEN')) 
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ CPM TOOL ]==============='))
